...
export const FirstMateHead = () => {
  return (
    <Head>
      ...
      <meta name="description" content="Creating products and tools for NFT Creators"></meta>
      ...
      <meta property="og:description" content="Your collection deserves its own marketplace."></meta>
      <meta property="og:url" content="https://firstmate.xyz"></meta>
      <meta property="og:image" content="https://firstmate.xyz/meta_image.png"></meta>
